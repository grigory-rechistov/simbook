...
\def \documentversion {2.4} % increment and don't forget to update history.tex
...
\usepackage{hyperref}
\hypersetup{colorlinks=true, linkcolor=black, filecolor=black, citecolor=black, urlcolor=black , pdfauthor=Grigory Rechistov <grigory.rechistov@phystech.edu>, pdftitle=Основы программного моделирования ЭВМ}
...
\title{Основы программного моделирования ЭВМ}
\date{\today}
