...
% * TL 2011 - a patched distro version (deprecated, may not work)
...
\def \documentversion {2.10$\beta$} % increment and don't forget to update history.tex
...
\newfontfamily\russianfont[Numbers=Uppercase, SmallCapsFont={EBGaramond12-SC},SmallCapsFeatures={Letters=SmallCaps}]{EB Garamond}
